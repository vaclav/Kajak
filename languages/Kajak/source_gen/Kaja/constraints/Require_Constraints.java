...
public class Require_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer canBeChildBreakingPoint = new SNodePointer("r:6c66d6ce-c8f4-4daf-92c4-a518b78006a8(Kaja.constraints)", "4394627182934757714");
  private static SNodePointer breakingNode_iz8172_a0a0a0a0a1a0b0a1a2 = new SNodePointer("r:6c66d6ce-c8f4-4daf-92c4-a518b78006a8(Kaja.constraints)", "4394627182935253715");

  public Require_Constraints() {
    super("Kaja.structure.Require");
  }
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            {
              final Iterable<SNode> libraries = ListSequence.fromList(SModelOperations.getRoots(_context.getModel(), "Kaja.structure.Library")).where(new IWhereFilter<SNode>() {
                public boolean accept(final SNode library) {
                  return ListSequence.fromList(SNodeOperations.getDescendants(SNodeOperations.getAncestor(_context.getEnclosingNode(), "Kaja.structure.Script", true, false), "Kaja.structure.Require", false, new String[]{})).where(new IWhereFilter<SNode>() {
              ...
              return new Scope() {
                ...
                public String getReferenceText(SNode contextNode, @NotNull SNode node) {
                  if (SNodeOperations.isInstanceOf(node, "Kaja.structure.Library")) {
                    return SPropertyOperations.getString(SNodeOperations.cast(node, "Kaja.structure.Library"), "name");
                  } else {
                    return null;
                  }
                }
  ...
  public static boolean static_canBeAChild(SNode node, SNode parentNode, SNode link, SNode childConcept, final IOperationContext operationContext) {
    return SNodeOperations.isInstanceOf(parentNode, "Kaja.structure.CommandList") && SNodeOperations.isInstanceOf(SNodeOperations.getParent(parentNode), "Kaja.structure.Script");
  }
}
