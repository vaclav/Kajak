...
public class CommentLine_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_dzsxo_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_dzsxo_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_dzsxo_a0(EditorContext editorContext, SNode node) {
