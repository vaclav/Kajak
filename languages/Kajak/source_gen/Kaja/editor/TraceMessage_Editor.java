...
public class TraceMessage_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_y0rgyt_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_y0rgyt_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_y0rgyt_a0(EditorContext editorContext, SNode node) {
