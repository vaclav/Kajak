      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            return new CompositeScope(SimpleRoleScope.forNamedElements(SNodeOperations.getAncestor(_context.getEnclosingNode(), "Kajak.structure.Script", true, false), SLinkOperations.findLinkDeclaration("Kajak.structure.Script", "definitions")), new Scope() {
              /**
